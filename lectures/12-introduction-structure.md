...
> 1\) find the corresponding points  
> 2\) superimpose and calculate score \(e.g. RMSD\)
...
> 2D distance map: difference of differences. Only information about the chirality is lost.
